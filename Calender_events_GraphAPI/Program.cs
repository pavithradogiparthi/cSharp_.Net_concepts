...
while (choice != 0)
{
    ...
    Console.WriteLine("3. List my Calender events");
...
async Task ListCalenderAsync()
{

    try
    {
        var messagePage = await GraphHelper.GetCalenderAsync();
    ...
    {
        Console.WriteLine($"Error getting user's calender: {ex.Message}");
    }
}
