  ...
  public class SamplesViewModel : ViewModelBase
  {
    ...
    public List<int> ExceptProductSalesMethod()
    {
      ...
      List<SalesOrder> sales = SalesOrderRepository.GetAll();
            ...
            list = products.Select(prod => prod.ProductID).Except(sales.Select(s => s.ProductID)).ToList();
      return list;
    }
    #endregion
    ...
    public List<Product> ExceptByProductSalesQuery()
    {
      ...
      List<SalesOrder> sales = SalesOrderRepository.GetAll();
            ...
            // Write Query Syntax Here
            list = (from prod in products select prod).ExceptBy(
                from sale in sales select sale.ProductID,prod=>prod.ProductID).ToList();
    ...
    public List<int> IntersectProductSalesQuery()
    {
      ...
      List<SalesOrder> sales = SalesOrderRepository.GetAll();
            ...
            // Write Query Syntax Here
            list = (from prod in products select prod.ProductID).Intersect(
                from sale in sales select sale.ProductID).ToList();
    ...
    public List<Product> IntersectByProductSalesMethod()
    {
      ...
      List<SalesOrder> sales = SalesOrderRepository.GetAll();
            ...
            // Write Method Syntax Here
            // list = products.IntersectBy(sales.Select(s=>s.ProductID), sale => sale.ProductID).ToList();
            //list = products.OrderBy(p => p.Name).Where(p=>p.Color=="Red").ToList();
            list = products.Where(p => p.Color == "Black").OrderBy(p => p.Name).ToList();
            return list;
    }
    #endregion
  }
