  ...
  public class SamplesViewModel : ViewModelBase
  {
    ...
    public List<int> UnionIntegersQuery()
    {
      ...
      List<int> list2 = new() { 1, 2, 3, 4, 5 };
          ...
          list=  (from num in list1 select num).
                Union(list2).OrderBy(num=>num).ToList();
    ...
    public List<Product> UnionQuery()
    {
      ...
      List<Product> list2 = ProductRepository.GetAll();
            ...
            list = (from prod in list1 select prod).
                Union(list2, pc).OrderBy(p => p.Name).ToList();
      return list;
    }
    #endregion
    ...
    public List<Product> UnionByQuery()
    {
      ...
      List<Product> list2 = ProductRepository.GetAll();
            ...
            list = (from prod in list1 select prod).UnionBy(list2, p => p.Color)
    ...
    public List<int> ConcatIntegersQuery()
    {
      ...
      List<int> list2 = new() { 1, 2, 3, 4, 5 };
            ...
            // Write Query Syntax Here
            list = (from num in list1 select num).
                Concat(list2).OrderBy(num => num).ToList();
    ...
    public List<Product> ConcatQuery()
    {
      ...
      List<Product> list2 = ProductRepository.GetAll();
            ...
            // Write Query Syntax Here
            list = (from prod in list1 select prod).Concat(list2)
                      .OrderBy(p => p.Name).ToList();
